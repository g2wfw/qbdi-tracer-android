...
/**
    ...
    @tags{Core}
*/
    class STL_API FileOutputStream : public OutputStream {
    public:
        //==============================================================================
        ...
        */
        ...
        FileOutputStream(const std::string fileToWriteTo, size_t bufferSizeToUse = 16384);
...
/** Destructor. */
    ...
    private:
        ...
        STL_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (FileOutputStream)
    };
