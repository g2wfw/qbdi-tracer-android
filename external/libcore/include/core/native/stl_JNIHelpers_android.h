...
private:
    ...
    STL_DECLARE_NON_COPYABLE (JNIClassBase)
};
...
namespace
{
    ...
    inline LocalRef<jstring> javaStringFromChar (const stl_wchar c)
    {
        char utf8[8] = { 0 };
...
inline constexpr auto generatedCallbackImpl =
    stl::toFnPtr (JNICALL [] (JNIEnv* env, jobject, jlong host, Args... args) -> Result
                   {
