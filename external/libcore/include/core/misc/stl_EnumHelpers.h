...
/**
    ...
    To use this, add the line STL_DECLARE_SCOPED_ENUM_BITWISE_OPERATORS (MyEnum)
    ...
    STL_DECLARE_SCOPED_ENUM_BITWISE_OPERATORS (MyEnum)
    ...
    @endcode
*/
#define STL_DECLARE_SCOPED_ENUM_BITWISE_OPERATORS(EnumType)               \
    static_assert (std::is_enum_v<EnumType>,                               \
                   "STL_DECLARE_SCOPED_ENUM_BITWISE_OPERATORS "           \
