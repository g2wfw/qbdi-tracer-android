#pragma once/*
  ...
  ==============================================================================
*/
#include "stl_ContainerDeletePolicy.h"
namespace stl
{
...
/**
    ...
    @tags{Core}
*/
class STL_EXPORT  ReferenceCountedObject
{
public:
    //==============================================================================
...
public:
    ...
    */
   ...
   #if STL_STRICT_REFCOUNTEDPOINTER
    /** Checks whether this pointer is null */
    ...
    /** Returns the object that this pointer references.
        ...
        with the pointer, it's safer to disable this by setting STL_STRICT_REFCOUNTEDPOINTER=1, which
