...
/**
    ...
    OR: just use the handy STL_DECLARE_WEAK_REFERENCEABLE macro to do all this for you.
...
public:
    ...
    */
    ...
    private:
        ...
        STL_DECLARE_NON_COPYABLE (SharedPointer)
    };
    ...
    */
    ...
    private:
        ...
        STL_DECLARE_NON_COPYABLE (Master)
    };
...
/**
     ...
     private:
         STL_DECLARE_WEAK_REFERENCEABLE (MyObject)
     };
     @endcode

     @see WeakReference, WeakReference::Master
*/
#define STL_DECLARE_WEAK_REFERENCEABLE(Class) \
    struct WeakRefMaster  : public stl::WeakReference<Class>::Master { ~WeakRefMaster() { this->clear(); } }; \
    WeakRefMaster masterReference; \
    friend class stl::WeakReference<Class>; \
