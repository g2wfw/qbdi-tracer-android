...
/**
    ...
    To use it, use the STL_HEAVYWEIGHT_LEAK_DETECTOR macro as a simple way to put
...
//==============================================================================
#if DOXYGEN || ! defined (STL_HEAVYWEIGHT_LEAK_DETECTOR)
 #if (DOXYGEN || STL_CHECK_MEMORY_LEAKS)
  /** This macro lets you embed a heavyweight leak-detecting object inside a class.

      To use it, simply declare a STL_HEAVYWEIGHT_LEAK_DETECTOR (YourClassName) inside a private section
      ...
      private:
          STL_HEAVYWEIGHT_LEAK_DETECTOR (MyClass)
      };
      @endcode
      ...
      @see HeavyweightLeakedObjectDetector, STL_LEAK_DETECTOR, LeakedObjectDetector
  */
  #define STL_HEAVYWEIGHT_LEAK_DETECTOR(OwnerClass) \
        friend class stl::HeavyweightLeakedObjectDetector<OwnerClass>; \
        static const char* getLeakedObjectClassName() noexcept { return #OwnerClass; } \
        stl::HeavyweightLeakedObjectDetector<OwnerClass> STL_JOIN_MACRO (leakDetector, __LINE__);
 #else
  #define STL_HEAVYWEIGHT_LEAK_DETECTOR(OwnerClass)
 #endif
#endif
