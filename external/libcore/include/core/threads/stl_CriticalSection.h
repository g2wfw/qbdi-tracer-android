...
#include "../stl_core.h"
#include "stl_ScopedLock.h"

namespace stl {

    class STL_EXPORT CriticalSection {
    public:
        //==============================================================================
    ...
    private:
        //==============================================================================
#if STL_WINDOWS
        // To avoid including windows.h in the public STL headers, we'll just allocate
        ...
        STL_DECLARE_NON_COPYABLE (CriticalSection)
    };
...
*/
    ...
    private:
        STL_DECLARE_NON_COPYABLE (DummyCriticalSection)
    };
