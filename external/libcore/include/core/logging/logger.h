...
#ifndef STL_LOG_NO_EXCEPTIONS
#    define STL_LOG_LOGGER_CATCH(location)                                                                                                  \
        catch (const std::exception &ex)                                                                                                   \
        {                                                                                                                                  \
            if (location.filename)                                                                                                         \
            {                                                                                                                              \
                err_handler_(fmt_lib::format(STL_LOG_STL_FMT_STRING("{} [{}({})]"), ex.what(), location.filename, location.line));              \
            }                                                                                                                              \
            else                                                                                                                           \
            {                                                                                                                              \
...
namespace stl {
    ...
    public:
        ...
        logger(logger &&other) STL_LOG_NOEXCEPT;

        logger &operator=(logger other) STL_LOG_NOEXCEPT;

        void swap(stl::logger &other) STL_LOG_NOEXCEPT;
    ...
    protected:
        ...
        stl::level_t level_{level::info};
        stl::level_t flush_level_{level::off};
