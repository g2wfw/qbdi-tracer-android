...
public:
    systemd_sink(std::string ident = "", bool enable_formatting = false)
        ...
        , syslog_levels_{{/* stl::level::trace      */ LOG_DEBUG,
              /* stl::level::debug      */ LOG_DEBUG,
              /* stl::level::info       */ LOG_INFO,
              /* stl::level::warn       */ LOG_WARNING,
              /* stl::level::err        */ LOG_ERR,
              /* stl::level::critical   */ LOG_CRIT,
              /* stl::level::off        */ LOG_INFO}}
    {}
