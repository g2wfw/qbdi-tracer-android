...
// GCC
  ...
  #error "STL requires GCC 7.0 or later"
 #endif

 #ifndef STL_EXCEPTIONS_DISABLED
  #if ! __EXCEPTIONS
   #define STL_EXCEPTIONS_DISABLED 1
  #endif
 #endif

 #define STL_CXX14_IS_AVAILABLE (__cplusplus >= 201402L)
 #define STL_CXX17_IS_AVAILABLE (__cplusplus >= 201703L)
...
// Clang
  ...
  #error "STL requires Clang 6 or later"
 #endif

 #ifndef STL_COMPILER_SUPPORTS_ARC
  #define STL_COMPILER_SUPPORTS_ARC 1
 #endif
  ...
  #endif
 #endif
#define STL_SILENCE_XCODE_15_LINKER_WARNING
 #if ! defined (STL_SILENCE_XCODE_15_LINKER_WARNING)                          \
  ...
  #pragma GCC warning "If you are using Link Time Optimisation (LTO), the "    \
      ...
      "STL_SILENCE_XCODE_15_LINKER_WARNING to your preprocessor definitions " \
   ...
   static_assert (std::string_view (__clang_version__)
                  ...
                  "15.1.\n"
                  "Once you've selected a workaround, you can add "
                  "STL_SILENCE_XCODE_15_LINKER_WARNING to your preprocessor "
...
// MSVC
   ...
   #error "STL requires Visual Studio 2017 or later"
 #endif
  ...
  #define STL_CXX14_IS_AVAILABLE (_MSVC_LANG >= 201402L)
  #define STL_CXX17_IS_AVAILABLE (_MSVC_LANG >= 201703L)
#endif

//==============================================================================
#if ! STL_CXX17_IS_AVAILABLE
 #error "STL requires C++17 or later"
#endif

//==============================================================================
#ifndef DOXYGEN
 // These are old flags that are now supported on all compatible build targets
 #define STL_COMPILER_SUPPORTS_OVERRIDE_AND_FINAL 1
 #define STL_COMPILER_SUPPORTS_VARIADIC_TEMPLATES 1
 #define STL_COMPILER_SUPPORTS_INITIALIZER_LISTS 1
 #define STL_COMPILER_SUPPORTS_NOEXCEPT 1
 #define STL_DELETED_FUNCTION = delete
