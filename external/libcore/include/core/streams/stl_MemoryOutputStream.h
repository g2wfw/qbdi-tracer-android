...
/**
    ...
    @tags{Core}
*/
    class STL_API MemoryOutputStream : public OutputStream {
    public:
        //==============================================================================
        ...
        */
        ...
        bool appendUTF8Char(stl_wchar character);
        ...
        */
        ...
        int64 seek(int64 newPosition) override;

        void alignTo(const size_t alignment) override;
    ...
    private:
        ...
        STL_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (MemoryOutputStream)
    };

/** Copies all the data that has been written to a MemoryOutputStream into another stream. */
    OutputStream &STL_CALLTYPE operator<<(OutputStream &stream, const MemoryOutputStream &streamToRead);
