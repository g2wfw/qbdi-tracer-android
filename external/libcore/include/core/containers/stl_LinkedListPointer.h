...
class STL_API LinkedListPointer
{
public:
    //==============================================================================
    ...
    */
    ...
    {
        STL_BEGIN_IGNORE_WARNINGS_MSVC (6011)
    ...
    */
    ...
    {
        STL_BEGIN_IGNORE_WARNINGS_MSVC (6011 28182)
        jassert (newItem != nullptr);
        jassert (newItem->nextListItem == nullptr);
    ...
    */
    ...
    private:
        ...
        STL_DECLARE_NON_COPYABLE (Appender)
    };
...
private:
    ...
    STL_DECLARE_NON_COPYABLE (LinkedListPointer)
};
