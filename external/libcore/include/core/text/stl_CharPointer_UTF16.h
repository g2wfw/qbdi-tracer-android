...
/**
    ...
    @tags{Core}
*/
class  STL_EXPORT CharPointer_UTF16  final
{
public:
   #if STL_NATIVE_WCHAR_IS_UTF16
    ...
    void write (stl_wchar charToWrite) noexcept
    {
    ...
    */
    static size_t getBytesRequiredFor (stl_wchar charToWrite) noexcept
    {
