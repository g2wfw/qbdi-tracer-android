...
/**
    ...
    This macro is used in the STL classes themselves, so your application has a chance to
    intercept and translate any internal STL text strings that might be shown. (You can easily
    get a list of all the messages by searching for the TRANS() macro in the STL source
    code).

    @tags{Core}
*/
class STL_EXPORT  LocalisedStrings
{
public:
    //==============================================================================
...
private:
    ...
    STL_LEAK_DETECTOR (LocalisedStrings)
};
 ...
 */
 #define TRANS(stringLiteral) stl::translate (stringLiteral)
#endif
