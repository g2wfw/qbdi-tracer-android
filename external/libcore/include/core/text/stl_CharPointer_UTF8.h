...
/**
    ...
    @tags{Core}
*/
class STL_EXPORT CharPointer_UTF8  final
{
public:
    using CharType = char;
    ...
    stl_wchar operator*() const noexcept
    {
        auto byte = (signed char) *data;

        if (byte >= 0)
            return (stl_wchar) (uint8) byte;
    ...
    stl_wchar getAndAdvance() noexcept
    {
        auto byte = (signed char) *data++;
    ...
    stl_wchar operator[] (int characterIndex) const noexcept
    {
        auto p (*this);
        p += characterIndex;
        return *p;
    ...
    */
    ...
    {
        STL_BEGIN_IGNORE_WARNINGS_MSVC (6387)
    ...
    */
    static size_t getBytesRequiredFor (const stl_wchar charToWrite) noexcept
    {
        size_t num = 1;
    ...
    */
    ...
    void write (const stl_wchar charToWrite) noexcept
    {
        auto c = (uint32) charToWrite;
    ...
    */
    ...
    bool isWhitespace() const noexcept          { return CharacterFunctions::isWhitespace ((stl_wchar) *(*this)); }
    ...
    stl_wchar toUpperCase() const noexcept     { return CharacterFunctions::toUpperCase (operator*()); }
    /** Returns a lower-case version of the first character of this string. */
    stl_wchar toLowerCase() const noexcept     { return CharacterFunctions::toLowerCase (operator*()); }
    ...
    */
    ...
    {
        STL_BEGIN_IGNORE_WARNINGS_MSVC (28182)
