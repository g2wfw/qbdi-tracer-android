...
/**
    ...
    @tags{Core}
*/
class STL_EXPORT CharPointer_UTF32  final
{
public:
    using CharType = stl_wchar;
    ...
    inline stl_wchar operator*() const noexcept        { return *data; }
    ...
    inline stl_wchar getAndAdvance() noexcept  { return *data++; }
    ...
    inline stl_wchar& operator[] (int characterIndex) const noexcept
    {
    ...
    inline void write (stl_wchar charToWrite) noexcept
    {
        *data++ = charToWrite;
    }

    inline void replaceChar (stl_wchar newChar) noexcept
    {
        *data = newChar;
    }
    ...
    {
       #if STL_NATIVE_WCHAR_IS_UTF32 && ! STL_ANDROID
        return wcslen (data);
       #else
        size_t n = 0;
        while (data[n] != 0)
    ...
    */
    static size_t getBytesRequiredFor (stl_wchar) noexcept
    {
    ...
    */
    ...
    int indexOf (stl_wchar charToFind) const noexcept
    {
        int i = 0;
    ...
    /** Returns the character index of a unicode character, or -1 if it isn't found. */
    int indexOf (stl_wchar charToFind, bool ignoreCase) const noexcept
    {
    ...
    stl_wchar toUpperCase() const noexcept     { return CharacterFunctions::toUpperCase (*data); }
    /** Returns a lower-case version of the first character of this string. */
    stl_wchar toLowerCase() const noexcept     { return CharacterFunctions::toLowerCase (*data); }
