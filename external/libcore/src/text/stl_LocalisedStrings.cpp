...
String LocalisedStrings::translateWithCurrentMappings (const String& text)  { return stl::translate (text); }
String LocalisedStrings::translateWithCurrentMappings (const char* text)    { return stl::translate (text); }

 String translate (const String& text)       { return stl::translate (text, text); }
 String translate (const char* text)         { return stl::translate (String (text)); }
 String translate (CharPointer_UTF8 text)    { return stl::translate (String (text)); }
