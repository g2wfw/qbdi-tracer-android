...
struct CurrentThreadHolder final : public ReferenceCountedObject
{
    ...
    STL_DECLARE_NON_COPYABLE (CurrentThreadHolder)
};
...
Thread* STL_CALLTYPE Thread::getCurrentThread()
{
...
struct LambdaThread final : public Thread
{
    ...
    STL_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (LambdaThread)
};
...
//==============================================================================
bool STL_CALLTYPE Process::isRunningUnderDebugger() noexcept
{
    return stl_isRunningUnderDebugger();
}
