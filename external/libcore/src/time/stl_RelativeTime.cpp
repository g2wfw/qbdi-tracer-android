...
RelativeTime RelativeTime::operator-= (double secs) noexcept        { numSeconds -= secs; return *this; }
 ...
 RelativeTime STL_CALLTYPE operator+ (RelativeTime t1, RelativeTime t2) noexcept  { return t1 += t2; }
 RelativeTime STL_CALLTYPE operator- (RelativeTime t1, RelativeTime t2) noexcept  { return t1 -= t2; }

 bool STL_CALLTYPE operator== (RelativeTime t1, RelativeTime t2) noexcept
{
 ...
 bool STL_CALLTYPE operator!= (RelativeTime t1, RelativeTime t2) noexcept
{
 ...
 bool STL_CALLTYPE operator>  (RelativeTime t1, RelativeTime t2) noexcept       { return t1.inSeconds() >  t2.inSeconds(); }
 bool STL_CALLTYPE operator<  (RelativeTime t1, RelativeTime t2) noexcept       { return t1.inSeconds() <  t2.inSeconds(); }
 bool STL_CALLTYPE operator>= (RelativeTime t1, RelativeTime t2) noexcept       { return t1.inSeconds() >= t2.inSeconds(); }
 bool STL_CALLTYPE operator<= (RelativeTime t1, RelativeTime t2) noexcept       { return t1.inSeconds() <= t2.inSeconds(); }
