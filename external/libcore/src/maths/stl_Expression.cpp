...
struct Expression::Helpers
{
    ...
    private:
        ...
        private:
            STL_DECLARE_NON_COPYABLE (EvaluationVisitor)
        };
        ...
        private:
            ...
            STL_DECLARE_NON_COPYABLE (SymbolVisitingVisitor)
        };
        ...
        private:
            ...
            STL_DECLARE_NON_COPYABLE (SymbolRenamingVisitor)
        };

        SymbolTerm* getSymbol() const  { return static_cast<SymbolTerm*> (left.get()); }

        STL_DECLARE_NON_COPYABLE (DotOperator)
    };
    ...
    private:
        STL_DECLARE_NON_COPYABLE (Subtract)
    };
    ...
    public:
        ...
        STL_DECLARE_NON_COPYABLE (Multiply)
    };
    ...
    public:
        ...
        STL_DECLARE_NON_COPYABLE (Divide)
    };
    ...
    private:
        ...
        STL_DECLARE_NON_COPYABLE (SymbolCheckVisitor)
    };
    ...
    private:
        ...
        STL_DECLARE_NON_COPYABLE (SymbolListVisitor)
    };
    ...
    private:
        ...
        //==============================================================================
        static bool isDecimalDigit (const stl_wchar c) noexcept
        {
            return c >= '0' && c <= '9';
        }

        bool readChar (const stl_wchar required) noexcept
        {
            if (*text == required)
            {
                ++text;
        ...
        bool readOperator (const char* ops, char* const opType = nullptr) noexcept
        {
            ...
            while (*ops != 0)
            {
                if (readChar ((stl_wchar) (uint8) *ops))
                {
                    if (opType != nullptr)
                        *opType = *ops;
        ...
        TermPtr readExpression()
        {
            ...
            while (lhs != nullptr && readOperator ("+-", &opType))
            {
                ...
                if (rhs == nullptr)
                    return parseError ("Expected expression after \"" + String::charToString ((stl_wchar) (uint8) opType) + "\"");
        ...
        STL_DECLARE_NON_COPYABLE (Parser)
    };
};
