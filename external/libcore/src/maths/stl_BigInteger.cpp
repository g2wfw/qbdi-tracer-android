...
//==============================================================================
    OutputStream &STL_CALLTYPE operator<<(OutputStream &stream, const BigInteger &value) {
    ...
    String BigInteger::toString(const int base, const int minimumNumCharacters) const {
        ...
        if (base == 2 || base == 8 || base == 16) {
            ...
            for (;;) {
                ...
                s = String::charToString((stl_wchar) (uint8) hexDigits[remainder]) + s;
            }
        } else if (base == 10) {
