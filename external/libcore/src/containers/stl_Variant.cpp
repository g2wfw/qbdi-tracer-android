...
//==============================================================================
    struct var::VariantType {
        ...
        static bool
        intEquals(const ValueUnion &data, const ValueUnion &otherData, const VariantType &otherType) noexcept {
        ...
        static bool
        int64Equals(const ValueUnion &data, const ValueUnion &otherData, const VariantType &otherType) noexcept {
        ...
        static String boolToString(const ValueUnion &data) {
            return String::charToString(data.boolValue ? (stl_wchar) '1' : (stl_wchar) '0');
        }

        static bool boolToBool(const ValueUnion &data) noexcept { return data.boolValue; }

        static bool
        boolEquals(const ValueUnion &data, const ValueUnion &otherData, const VariantType &otherType) noexcept {
        ...
        static bool
        arrayEquals(const ValueUnion &data, const ValueUnion &otherData, const VariantType &otherType) noexcept {
            auto *thisArray = arrayToArray(data);
            auto *otherArray = otherType.toArray(otherData);
            return thisArray == otherArray ||
                   (thisArray != nullptr && otherArray != nullptr && *otherArray == *thisArray);
        }
...
//==============================================================================
    ...
    var::var(const Array<var> &v) : type(
            &Instance::attributesArray) { value.objectValue = new VariantType::RefCountedArray(v); }
...
//==============================================================================
    ...
    DynamicObject *var::getDynamicObject() const noexcept { return (DynamicObject *) getObject(); }
...
//==============================================================================
    ...
    const var &getNullVarRef() noexcept;
...
//==============================================================================
    ...
    var var::call(const Identifier &method, const var &arg1, const var &arg2, const var &arg3, const var &arg4,
