...
//==============================================================================
#ifdef STL_DLL_BUILD
  void* juceDLL_malloc (size_t sz)    { return std::malloc (sz); }
  void  juceDLL_free (void* block)    { std::free (block); }
#endif
...
//==============================================================================
#if STL_INTEL
 #if STL_MSVC && ! defined (__INTEL_COMPILER)
  #pragma intrinsic (__cpuid)
  #pragma intrinsic (__rdtsc)
 #endif

 #if STL_MINGW || STL_CLANG
...
void CPUInformation::initialise() noexcept
{
    ...
    STL_BEGIN_IGNORE_WARNINGS_GCC_LIKE ("-Wshift-sign-overflow")
...
String SystemStats::getOperatingSystemName()
{
    ...
    switch (getOperatingSystemType())
    {
        ...
        case MacOSX:            STL_FALLTHROUGH
        case Windows:           STL_FALLTHROUGH
        case Linux:             STL_FALLTHROUGH
        case Android:           STL_FALLTHROUGH
        case iOS:               STL_FALLTHROUGH

        case MacOSX_10_7:       STL_FALLTHROUGH
        case MacOSX_10_8:       STL_FALLTHROUGH
        case MacOSX_10_9:       STL_FALLTHROUGH
        case MacOSX_10_10:      STL_FALLTHROUGH
        case MacOSX_10_11:      STL_FALLTHROUGH
        case MacOSX_10_12:      STL_FALLTHROUGH
        case MacOSX_10_13:      STL_FALLTHROUGH
        case MacOSX_10_14:      STL_FALLTHROUGH
        case MacOSX_10_15:      STL_FALLTHROUGH
        case MacOS_11:          STL_FALLTHROUGH
        case MacOS_12:          STL_FALLTHROUGH
        case MacOS_13:          STL_FALLTHROUGH

        case UnknownOS:         STL_FALLTHROUGH
        case WASM:              STL_FALLTHROUGH
...
public:
        ...
        : hiResTicksOffset (0)
    {
        ...
        // always been the value used in STL apps, and changing it could
        ...
        // function.
       #ifndef STL_WIN32_TIMER_PERIOD
        #define STL_WIN32_TIMER_PERIOD 1
       #endif

       #if STL_WIN32_TIMER_PERIOD > 0
        [[maybe_unused]] auto res = timeBeginPeriod (STL_WIN32_TIMER_PERIOD);
...
//==============================================================================
static int64 stl_getClockCycleCounter() noexcept
{
 #if STL_MSVC
  #if STL_INTEL
...
{
    auto cycles = stl_getClockCycleCounter();
    ...
    for (;;)
    {
        ...
        auto cyclesNow = stl_getClockCycleCounter();
...
String SystemStats::getUniqueDeviceID()
{
    ...
    // Please tell someone at STL if this occurs
    jassertfalse;
    return {};
}
