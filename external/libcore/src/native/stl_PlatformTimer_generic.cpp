...
private:
    ...
    private:
        ...
        STL_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (Timer)
        STL_DECLARE_NON_MOVEABLE (Timer)
    };
    ...
    STL_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (PlatformTimer)
    STL_DECLARE_NON_MOVEABLE (PlatformTimer)
};
