...
//==============================================================================
bool STL_CALLTYPE Process::openEmailWithAttachments ([[maybe_unused]] const String& targetEmailAddress,
...
private:
    ...
    STL_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (URLConnectionStateBase)
};
...
// in the future.
STL_BEGIN_IGNORE_WARNINGS_GCC_LIKE ("-Wdeprecated")
...
private:
    ...
    {
        DelegateClass()  : ObjCClass<NSObject> ("STLNetworkDelegate_")
        {
    ...
    STL_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (URLConnectionStatePreYosemite)
};
...
private:
    ...
    struct DelegateClass final : public ObjCClass<NSObject>
    {
        DelegateClass()  : ObjCClass<NSObject> ("STL_URLDelegate_")
        {
    ...
    STL_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (URLConnectionState)
};
...
struct BackgroundDownloadTask final : public URL::DownloadTask
{
           ...
           uniqueIdentifier (String (urlToUse.toString (true).hashCode64()) + String (Random().nextInt64()))
    {
        ...
        STL_BEGIN_IGNORE_WARNINGS_GCC_LIKE ("-Wnullable-to-nonnull-conversion")
    ...
    {
        DelegateClass()  : ObjCClass<NSObject<NSURLSessionDelegate>> ("STL_URLDelegate_")
        {
...
void URL::DownloadTask::stl_iosURLSessionNotify (const String& identifier)
{
