...
DispatchLibc::DispatchLibc() {
    ...
    REGISTER_HANDLER(libc_handlers, memmem, {
        ...
        trace_info->fun_call->args.push_back(
                fmt::format("haystacklen={:#x}", get_arg_register_value(&trace_info->pre_status, 1)));
        trace_info->fun_call->args.push_back(
    ...
    REGISTER_HANDLER(libc_handlers, stpcpy, {
        ...
        auto arg0 = get_arg_register_value(&trace_info->pre_status, 0);
        auto arg1 = get_arg_register_value(&trace_info->pre_status, 1);
        trace_info->fun_call->args.push_back(fmt::format("dest={}", read_string_from_address(arg0)));
    ...
    REGISTER_HANDLER(libc_handlers, strstr, {
        ...
        auto arg0 = get_arg_register_value(&trace_info->pre_status, 0);
        auto arg1 = get_arg_register_value(&trace_info->pre_status, 1);
        trace_info->fun_call->args.push_back(fmt::format("haystack={}", read_string_from_address(arg0)));
        trace_info->fun_call->args.push_back(fmt::format("needle={}", read_string_from_address(arg1)));
        trace_info->fun_call->ret_type = kString;
    });
    //strcasestr
    ...
    REGISTER_HANDLER(libc_handlers, strtok, {
        ...
        auto arg1 = get_arg_register_value(&trace_info->pre_status, 1);
        trace_info->fun_call->args.push_back(fmt::format("s={}", read_string_from_address(arg0)));
        trace_info->fun_call->args.push_back(fmt::format("delim={}", read_string_from_address(arg1)));
        trace_info->fun_call->ret_type = kString;
    });
    //strtok_r
    ...
    REGISTER_HANDLER(libc_handlers, strcspn, {
        ...
        auto arg1 = get_arg_register_value(&trace_info->pre_status, 1);
        trace_info->fun_call->args.push_back(fmt::format("s={}", read_string_from_address(arg0)));
        trace_info->fun_call->args.push_back(fmt::format("reject={}", read_string_from_address(arg1)));
        trace_info->fun_call->ret_type = kNumber;
    });
    //strpbrk
    REGISTER_HANDLER(libc_handlers, strpbrk, {
        ...
        auto arg1 = get_arg_register_value(&trace_info->pre_status, 1);
        trace_info->fun_call->args.push_back(fmt::format("s={}", read_string_from_address(arg0)));
        trace_info->fun_call->args.push_back(fmt::format("accept={}", read_string_from_address(arg1)));
        trace_info->fun_call->ret_type = kString;
    });
    //strsep
    REGISTER_HANDLER(libc_handlers, strsep, {
        ...
        auto arg0 = get_arg_register_value(&trace_info->pre_status, 0);
        auto arg1 = get_arg_register_value(&trace_info->pre_status, 1);
        trace_info->fun_call->args.push_back(fmt::format("stringp={}", read_string_from_address(arg0)));
        trace_info->fun_call->args.push_back(fmt::format("delim={}", read_string_from_address(arg1)));
        trace_info->fun_call->ret_type = kString;
    });
    //strspn
    ...
    REGISTER_HANDLER(libc_handlers, setenv, {
        ...
        auto arg2 = get_arg_register_value(&trace_info->pre_status, 2);
        trace_info->fun_call->args.push_back(fmt::format("name={}", read_string_from_address(arg0)));
        trace_info->fun_call->args.push_back(fmt::format("value={}", read_string_from_address(arg1)));
    ...
    REGISTER_HANDLER(libc_handlers, putenv, {
        ...
        auto arg0 = get_arg_register_value(&trace_info->pre_status, 0);
        trace_info->fun_call->args.push_back(fmt::format("string={}", read_string_from_address(arg0)));
        trace_info->fun_call->ret_type = kNumber;
    });
    //unsetenv
    ...
    REGISTER_HANDLER(libc_handlers, mkdtemp, {
        ...
        auto arg0 = get_arg_register_value(&trace_info->pre_status, 0);
        trace_info->fun_call->args.push_back(fmt::format("template={}", read_string_from_address(arg0)));
        trace_info->fun_call->ret_type = kString;
    });
    //mktemp
    ...
    REGISTER_HANDLER(libc_handlers, strtol, {
        ...
        auto arg1 = get_arg_register_value(&trace_info->pre_status, 1);
        auto arg2 = get_arg_register_value(&trace_info->pre_status, 2);
        trace_info->fun_call->args.push_back(fmt::format("nptr={}", read_string_from_address(arg0)));
...
/*
    ...
    REGISTER_HANDLER(libc_handlers, link, {
        auto arg0 = get_arg_register_value(&trace_info->pre_status, 0);
        trace_info->fun_call->args.push_back(fmt::format("old_path={}", read_string_from_address(arg0)));
        auto arg1 = get_arg_register_value(&trace_info->pre_status, 1);
        trace_info->fun_call->args.push_back(fmt::format("new_path={}", read_string_from_address(arg1)));
        trace_info->fun_call->ret_type = kNumber;
    });
...
// int linkat(int __old_dir_fd, const char* __old_path, int __new_dir_fd, const char* __new_path, int __flags)
    REGISTER_HANDLER(libc_handlers, linkat, {
        ...
        auto arg1 = get_arg_register_value(&trace_info->pre_status, 1);
        trace_info->fun_call->args.push_back(fmt::format("old_path={}", read_string_from_address(arg1)));
        auto arg2 = get_arg_register_value(&trace_info->pre_status, 2);
        trace_info->fun_call->args.push_back(fmt::format("new_dir_fd={:#x}", arg2));
        auto arg3 = get_arg_register_value(&trace_info->pre_status, 3);
        trace_info->fun_call->args.push_back(fmt::format("new_path={}", read_string_from_address(arg3)));
        auto arg4 = get_arg_register_value(&trace_info->pre_status, 4);
...
// int symlinkat(const char* __old_path, int __new_dir_fd, const char* __new_path)
    REGISTER_HANDLER(libc_handlers, symlinkat, {
        ...
        auto arg2 = get_arg_register_value(&trace_info->pre_status, 2);
        trace_info->fun_call->args.push_back(fmt::format("new_path={}", read_string_from_address(arg2)));
        trace_info->fun_call->ret_type = kNumber;
    });
...
// int pthread_cond_wait(pthread_cond_t* __cond, pthread_mutex_t* __mutex)
    ...
    REGISTER_HANDLER(libc_handlers, utimes, {
        {
            auto arg0 = get_arg_register_value(&trace_info->pre_status, 0);
            trace_info->fun_call->args.push_back(fmt::format("path=\"{}\"", reinterpret_cast<const char *>(arg0)));
            auto arg1 = get_arg_register_value(&trace_info->pre_status, 1);
    ...
    REGISTER_HANDLER(libc_handlers, fprintf, {
        {
            ...
            trace_info->fun_call->args.push_back(fmt::format("fp={{:#x}}", arg0));
            auto arg1 = get_arg_register_value(&trace_info->pre_status, 1);
            trace_info->fun_call->args.push_back(fmt::format("fmt=\"{}\"", reinterpret_cast<const char *>(arg1)));
    ...
    REGISTER_HANDLER(libc_handlers, fputs, {
        {
            auto arg0 = get_arg_register_value(&trace_info->pre_status, 0);
            trace_info->fun_call->args.push_back(fmt::format("s=\"{}\"", reinterpret_cast<const char *>(arg0)));
            auto arg1 = get_arg_register_value(&trace_info->pre_status, 1);
            trace_info->fun_call->args.push_back(fmt::format("fp={{:#x}}", arg1));
            trace_info->fun_call->ret_type = kNumber;
        }
...
/*    int remove(const char* __path);
    ...
    REGISTER_HANDLER(libc_handlers, scanf, {
        auto arg0 = get_arg_register_value(&trace_info->pre_status, 0);
        trace_info->fun_call->args.push_back(fmt::format("fmt={}", reinterpret_cast<const char *>(arg0)));
        trace_info->fun_call->ret_type = kNumber;
    });

    //int sscanf(const char* __s, const char* __fmt, ...)
    REGISTER_HANDLER(libc_handlers, sscanf, {
        {
            auto arg0 = get_arg_register_value(&trace_info->pre_status, 0);
            auto arg1 = get_arg_register_value(&trace_info->pre_status, 1);
            trace_info->fun_call->args.push_back(fmt::format("s={}", reinterpret_cast<const char *>(arg0)));
